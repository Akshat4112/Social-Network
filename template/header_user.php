            ...
            <div class="container-fluid">
                <div class="row mdl-color--blue-800 widthclass">
                    ...
                    <div class="navbar-header col-sm-4">
                        <a class="navbar-brand" href="home.php"><img src="./images/new.jpg" height="30px" width="30px"></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <div class="col-sm-4">
                            <form class="navbar-form navbar-left" method="get" action="results.php">
                                ...
                                <button type="submit" class="btn btn-default mdl-color--green-500 mdl-color-text--grey-50" name="search">Search</button>
                            </form>
                        </div>
